...
async def calculate_monthly_revenue(property_id: str, month: int, year: int, db_session=None) -> Decimal:
    ...
    Uses property timezone to correctly classify reservations at month boundaries.
    """
    ...
    # Use timezone-aware query that converts check_in_date to the property's local timezone
    query = """
